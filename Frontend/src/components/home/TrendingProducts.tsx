    ...
    <section className="py-24 bg-premium-pearl/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          ...
          <a href="/shop?sort=trending" className="hidden md:inline-flex items-center text-sm font-semibold tracking-widest uppercase text-gray-500 hover:text-primary-700 transition-colors">
        ...
        <div className="mt-12 text-center md:hidden">
          <a href="/shop?sort=trending" className="inline-flex items-center text-sm font-semibold tracking-widest uppercase text-primary-700 border-b border-primary-700 pb-1 hover:text-accent hover:border-accent transition-colors">
            View All Trending
          </a>
        </div>
