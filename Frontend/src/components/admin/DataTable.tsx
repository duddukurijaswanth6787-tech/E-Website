    ...
    <div className={`overflow-hidden font-sans ${embedded ? '' : 'bg-white rounded-xl shadow-sm border border-gray-200'}`}>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm text-gray-600">
          <thead className="bg-gray-50 text-gray-900 border-b border-gray-200 uppercase tracking-wider text-xs font-semibold">
            <tr>
              {columns.map((col, idx) => (
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between text-sm text-gray-500 bg-gray-50/50">
          ...
          <div className="flex gap-2">
            <button 
              ...
              className="p-1 border border-gray-300 rounded bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed text-gray-600 transition-colors"
            >
