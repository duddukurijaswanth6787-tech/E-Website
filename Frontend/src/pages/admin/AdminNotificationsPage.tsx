    ...
    { 
       ...
       accessor: (row: NotificationNode) => (
         <div className="max-w-xs group">
           ...
           <span className="block text-xs text-[var(--admin-text-secondary)] line-clamp-1 mt-0.5" title={row.body}>{row.body}</span>
    ...
    { 
       ...
       accessor: (row: NotificationNode) => (
         <div className="flex items-center space-x-2">
           ...
           <span className="block text-[0.65rem] font-black tracking-widest uppercase text-[var(--admin-text-secondary)]">{row.channel}</span>
         </div>
       )
    },
    { 
    ...
    <div className="space-y-6 max-w-[100vw] overflow-hidden">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
        <div>
          ...
          <p className="text-sm text-[var(--admin-text-secondary)]">Inject massive campaign notifications, order system alerts, and verify SMS/Email delivery traces.</p>
        </div>
