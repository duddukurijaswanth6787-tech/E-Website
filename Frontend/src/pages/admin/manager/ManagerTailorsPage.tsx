  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-black text-[var(--admin-text-primary)] tracking-tight uppercase">Production Workforce</h1>
          </div>
          <p className="text-stone-500 text-sm font-medium">Real-time workload heatmap and productivity tracking.</p>
        </div>

        <div className="flex gap-2">
          <button className="flex items-center gap-2 px-4 py-2 bg-[var(--admin-card)] text-[var(--admin-text-primary)] rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-stone-800 transition-all shadow-lg shadow-stone-900/10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-[var(--admin-card)] border border-[var(--admin-card-border)] rounded-2xl p-6 shadow-sm">
          ...
          <h3 className="text-3xl font-black text-[var(--admin-text-primary)] mb-1">{availableCount}</h3>
        ...
        <div className="bg-[var(--admin-card)] border border-[var(--admin-card-border)] rounded-2xl p-6 shadow-sm">
          ...
          <h3 className="text-3xl font-black text-[var(--admin-text-primary)] mb-1">{overloadedCount}</h3>
          <p className="text-xs font-bold text-stone-400 uppercase tracking-widest">Overloaded Personnel</p>
        </div>

        <div className="bg-[var(--admin-card)] border border-stone-800 rounded-2xl p-6 shadow-xl shadow-stone-900/10 text-[var(--admin-text-primary)]">
          <div className="flex justify-between items-start mb-4">
      ...
      <div className="bg-[var(--admin-card)] border border-[var(--admin-card-border)] rounded-2xl p-4 mb-6 flex flex-col md:flex-row gap-4 items-center justify-between shadow-sm">
        <div className="relative w-full md:max-w-md">
          <Search className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-stone-400" />
          <input 
            type="text" 
            placeholder="Search by name or tailor code..." 
            className="w-full pl-10 pr-4 py-2 bg-[var(--admin-card)] border-[var(--admin-card-border)] rounded-xl text-sm focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all"
            value={searchQuery}
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <button className="flex-1 md:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-[var(--admin-card)] border border-[var(--admin-card-border)] rounded-xl text-xs font-bold text-stone-600 hover:bg-[var(--admin-card)] transition-all">
