  ...
  return (
    <div className="p-6 md:p-8 min-h-screen">
      <div className="flex justify-between items-center mb-6">
         ...
         <Link to="/custom-blouse" className="text-sm font-bold uppercase tracking-widest text-primary-700 bg-primary-50 px-4 py-2 rounded">New Consultation</Link>
      </div>
      ...
      {requests.length === 0 ? (
        <div className="text-center py-16 bg-gray-50 rounded-xl border border-gray-100">
          ...
          <Link to="/custom-blouse" className="bg-primary-950 text-white px-8 py-3 rounded text-sm font-bold uppercase tracking-widest">Start a Request</Link>
        </div>
      ) : (
