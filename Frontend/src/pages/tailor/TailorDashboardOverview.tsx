...
const TailorDashboardOverview = () => {
  ...
  // Fetch all tasks using custom hook (with polling)
  ...
  if (error) {
    return <div className="p-4 bg-red-50 text-red-600 rounded-lg">Failed to load dashboard data.</div>;
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex items-center">
          ...
          <div>
            ...
            {/* Mocked today completion count for now */}
