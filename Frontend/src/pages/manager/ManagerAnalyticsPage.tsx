      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
        ...
        <div className="bg-white border border-stone-200 rounded-3xl p-8 shadow-sm">
           ...
           <div className="space-y-4">
              ...
              <div className="p-4 bg-stone-50 rounded-2xl border border-stone-200 flex items-center justify-between opacity-50">
                <div>
                  <p className="text-xs font-black text-stone-900 uppercase">Finishing / QC</p>
                  <p className="text-[10px] text-stone-500 font-medium">System Nominal</p>
                </div>
